...
local function parseColor(self, color, isOutline)
	if color == "Team Color" or (self.interface.sharedSettings.useTeamColor and not isOutline) then
		return self.interface.getTeamColor(self.player) or Color3.new(0,61,255);
	end
	return color;
end
...
local EspInterface = {
	...
	teamSettings = {
		enemy = {
			enabled = false,
			box = false,
			boxColor = { Color3.new(0,61,255), 1 },
			boxOutline = true,
			boxOutlineColor = { Color3.new(), 1 },
			boxFill = false,
			boxFillColor = { Color3.new(1,1,1), 0.1 },
			healthBar = false,
			...
			name = false,
			nameColor = { Color3.new(0,61,255), 1 },
			nameOutline = true,
			...
			distance = false,
			distanceColor = { Color3.new(0,61,255), 1 },
			distanceOutline = true,
			distanceOutlineColor = Color3.new(),
			tracer = false,
			tracerOrigin = "Bottom",
			tracerColor = { Color3.new(0,61,255), 1 },
			tracerOutline = true,
			tracerOutlineColor = { Color3.new(), 1 },
			offScreenArrow = false,
			offScreenArrowColor = { Color3.new(0,61,255), 1 },
